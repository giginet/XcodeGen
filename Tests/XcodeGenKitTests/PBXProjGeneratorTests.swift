...
//extension Project {
//
//    func generateXcodeProject(validate: Bool = true, file: String = #file, line: Int = #line) async throws -> XcodeProj {
//        try doThrowing(file: file, line: line) {
//            if validate {
//                try self.validate()
//            }
//            let generator = ProjectGenerator(project: self)
//            return try await ugenerator.generateXcodeProject(userName: "someUser")
//        }
//    }
//
//    func generatePbxProj(specValidate: Bool = true, projectValidate: Bool = true, file: String = #file, line: Int = #line) async throws -> PBXProj {
//        try doThrowing(file: file, line: line) {
//            let xcodeProject = try await generateXcodeProject(validate: specValidate).pbxproj
//            if projectValidate {
...
//    }
//    
//    func testDefaultLastUpgradeCheckWhenUserDidSpecifyInvalidValue() async throws {
...
//        let projGenerator = PBXProjGenerator(project: project)
//        
//        let pbxProj = try await projGenerator.generate()
//
...
//    }
//    
//    func testOverrideLastUpgradeCheckWhenUserDidSpecifyValue() async throws {
//        let lastUpgradeKey = "LastUpgradeCheck"
...
//    }
//    
//    func testDefaultLastUpgradeCheckWhenUserDidNotSpecifyValue() async throws {
//        let lastUpgradeKey = "LastUpgradeCheck"
